    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.book}>
                ...
                <TouchableOpacity  onPress={() => navigation.navigate('Parte4')}><Text style={styles.ChoseText}>Ficar Parada</Text></TouchableOpacity>
                <Text style={styles.Text}>OU</Text>
                <TouchableOpacity  onPress={() => navigation.navigate('')} ><Text style={styles.ChoseText}>FUGIR</Text></TouchableOpacity>
